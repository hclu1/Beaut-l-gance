...
<div className="border border-gray-200 rounded-lg p-4 mb-4 bg-gray-50">
  <label className="flex items-start gap-3 cursor-pointer">
    ...
    <span className="text-sm text-gray-600 leading-relaxed">
      J'accepte que mes données personnelles (nom, prénom, email, téléphone, adresse) 
      soient utilisées par <strong>Beauté & Élégance</strong> uniquement pour le traitement 
      de ma commande. Ces données sont conservées 3 ans et ne sont pas revendues. 
      Conformément au RGPD, vous pouvez demander leur suppression à tout moment en 
      contactant <a href="mailto:hchampag1@hotmail.fr" className="text-purple-600 underline">hchampag1@hotmail.fr</a>.
    </span>
  </label>
  {errors.consent && (
